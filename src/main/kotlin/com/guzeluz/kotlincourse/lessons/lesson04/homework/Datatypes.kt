package com.guzeluz.kotlincourse.lessons.lesson04.homework
...
//Boolean type is case-sensitive
//val v6 = FALSE
val v7: Char = 'c'
val v8: Short = 500
...
val v19: Float = 5.75f
// Type Char can contain only 1 character
//val v20 = `1.414`
...
// String can contain Emoji, but in this example used wrong quotes
//val v32 = “🤯”
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
// String type can contain numbers, but in this example used wrong quotes.
//val v34 = ‘65535’
val v35: Long = 72057594037927935L
//It is right, because Float can store many decimal places, but it cannot guarantee exact precision beyond ~6–7 significant digits.
...
val v56: List<String> = listOf("Why are the bug closed?", "")
